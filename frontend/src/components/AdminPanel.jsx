  ...
  return (
    <div>
      ...
      <ul className="list-group mb-4">
        {team.map(member => (
          <li key={member._id} className="list-group-item">{member.name} - {member.role}</li>
        ))}
      </ul>
      ...
      <input className="form-control mb-2" placeholder="Price" type="number" onChange={e => setProduct({ ...product, price: e.target.value })} />
      <input className="form-control mb-2" placeholder="Image URL" onChange={e => setProduct({ ...product, image: e.target.value })} />
